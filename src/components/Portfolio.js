...
function Portfolio() {
  return (
    <div className="bg-ligh">
      {/* Navbar */}
     <nav className="navbar navbar-expand-lg navbar-dark bg-white shadow-sm py-1">
  <div className="container-fluid" style={{ paddingLeft: "20px" }}>
    <a
      className="navbar-brand fw-bold textcolour"
      href="#home"
      style={{ color: "#1f6ea7" }}
    >
      <img
        src={logo}
        alt="Moc Connect Logo"
        style={{ height: "60px" }}
      />{" "}
      Moc Connect Pvt. Ltd.
    </a>
...
<motion.section
  id="home"
  className="text-center py-5 header text-white"
  style={{
...
>
  Our Team
        ...
        <div className="row g-4 text-center">
          {[ 
            {Name:"Srinivas Gurazala",Desc:"Founder/Director"},{ Name:"Harika Gurazala",Desc:"Managing Director/Developer"},{Name:"Srinivas Gurazala", Desc:"Designer/Developer"}].map((role, index) => (
  ...
  <div className="container text-white">
    ...
    <div className="text-center mb-1">
      ...
      <footer className="text-center py-3 bg-secondary text-white">
        <p className="mb-0">© {new Date().getFullYear()} Moc Connect Pvt. Ltd.</p>
      </footer>
    </div>
  );
}
